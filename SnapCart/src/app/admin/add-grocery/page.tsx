...
function AddGrocery() {
    ...
    const [preview,setPreview]=useState<string|null>()// either url or null
    ...
    const handleImageChange=async (e:ChangeEvent<HTMLInputElement>)=>{
        ...
        // will convert the image into URL and work as the src of image in preview
                ...
                <div>
                 ...
                 <div className='grid grid-cols-1 sm:grid-cols-2 gap-3'>
                        <div >
                            ...
                            <select name="category" value={category} className='w-full border cursor-pointer border-gray-300 rounded-xl px-4 py-3 outline-none focus:ring-2 focus:ring-green-400 transition-all bg-white' onChange={(e)=>setCategory(e.target.value)}>
                        ...
                        <div>
                            <label htmlFor='unit' className='block text-gray-700 font-medium mb-1'>Unit<span className='text-red-500'>*</span></label>
                            <select name="unit" id='unit' className='w-full cursor-pointer border border-gray-300 rounded-xl px-4 py-3 outline-none focus:ring-2 focus:ring-green-400 transition-all bg-white'
                    ...
                    <motion.button
                                        ...
                                        className='mt-4 w-full bg-linear-to-r from-green-500 cursor-pointer to-green-700 text-white font-semibold py-3 rounded-xl shadow-lg hover:shadow-xl disabled:opacity-60 transition-all flex items-center justify-center gap-2'
                                        >
